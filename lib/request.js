...
class request {
	 ...
	 * @summary Returns the request.remote class for this request.
	 * @return {Class} The request.remote class for this request.
	 * @function remote
	 */
	remote() {
	 ...
	 * @summary Returns the request.local class for this request.
	 * @return {Class} The request.local class for this request.
	 * @function local
	 */
	local() {
	 ...
	 * @summary Returns the request.headers class.
	 * @return {Class} The request.headers class.
	 * @function headers
	 */
	headers() {
	 ...
	 * that were sent in the request.
	 * @summary Returns the request.cookies class.
	 * @return {Class} The request.cookies class.
	 * @function cookies
	 */
	cookies() {
	 ...
	 * @summary Returns the request.accepts class.
	 * @return {Class} The request.accepts class. 
	 * @function accepts
	 */
	accepts() {
	 ...
	 * @summary Returns the request.bytes class.
	 * @return {Class} The request.bytes class.
	 * @function bytes
	 */
	bytes() {
	 ...
	 * @summary Returns the request.agent class.
	 * @return {Class} The request.agent class.
	 * @function agent
	 */
	agent() {
